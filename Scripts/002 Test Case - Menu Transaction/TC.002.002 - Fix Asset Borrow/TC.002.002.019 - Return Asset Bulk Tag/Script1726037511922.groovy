...
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.081 Verify Return Asset'))
...
WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.019 -  Return Asset Bulk Tag.png', FailureHandling.STOP_ON_FAILURE)
