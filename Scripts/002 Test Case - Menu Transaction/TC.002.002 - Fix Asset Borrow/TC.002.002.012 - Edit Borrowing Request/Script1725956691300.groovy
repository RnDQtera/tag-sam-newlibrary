...
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.055 Edit Request Borrowing'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.056 Edit Duration Day'), '2')

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.057 Save Edit Borrowing Request'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.012 - Edit Borrowing Request.png', FailureHandling.STOP_ON_FAILURE)
