...
//WebUI.delay(10, FailureHandling.STOP_ON_FAILURE)
//
//WebUI.sendKeys(findTestObject('00-16 Select Single Scan QR - Borrow Transaction'), Keys.chord(Keys.ESCAPE))
//
//WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.027 Next Page Asset Confirm Handover'), FailureHandling.STOP_ON_FAILURE)
//
//WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.028 Send Email Asset Confirm Handover'), FailureHandling.STOP_ON_FAILURE)
...
//
//WebUI.delay(2)
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.115 Borrow Sub Tab Borrowed'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.116 Button Filter Sub tab Borrowed'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.117 Section Name Sub Tab Borrowed'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.118 Text Field Section Name'), 'Meja Rapat')

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.119 Check Data Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Name.png', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.120 Section Status Sub Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.118 Text Field Section Name'), 'On Borrowing')

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.119 Check Data Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Status.png', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.125 Select FIlter Group Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.126 Set Text Field Select Group'), 'Kantor Regional JaTim')

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.127 Check Data Select Group'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.128 Submit Data Select group'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Group.png', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.121 Section Borrower Sub Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.118 Text Field Section Name'), 'Smith Doe')

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.119 Check Data Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Borrower.png', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.122 Section Manager Sub Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Manager.png', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.123 Section Date Sub Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.129 Select Date FIlter Borrwed'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Date.png', FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.124 Section Return Date Sub Tab Borrowed'), FailureHandling.STOP_ON_FAILURE)

WebUI.doubleClick(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.130 Select Return Date'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Filter Section Date Return.png', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.131 Apply Filter'), FailureHandling.STOP_ON_FAILURE)

WebUI.refresh()

WebUI.delay(5)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.132 Button Search Data Borrowed'))

WebUI.setText(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.133 Text Field Serach Asset Borrowed'), 'Sofa Loby - 1')

WebUI.sendKeys(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.133 Text Field Serach Asset Borrowed'), Keys.chord(
        Keys.ENTER))

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.025 - Result Search Asset Borrowed.png', FailureHandling.STOP_ON_FAILURE)
