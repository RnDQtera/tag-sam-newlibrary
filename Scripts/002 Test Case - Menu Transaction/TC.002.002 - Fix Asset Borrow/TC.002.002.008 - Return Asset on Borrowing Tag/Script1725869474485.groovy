...
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.051 Verify Asset for Return Asset'))
...
WebUI.sendKeys(findTestObject('00-12 Select Single Scan RFID - Return Borrow'), Keys.chord(Keys.ESCAPE))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.050 Submit Return Asset'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.008 - Return Asset Tag.png', FailureHandling.STOP_ON_FAILURE)
