...
//WebUI.delay(10, FailureHandling.STOP_ON_FAILURE)
//
//WebUI.sendKeys(findTestObject('00-10 Select Single Scan RFID'), Keys.chord(Keys.ESCAPE))
//
...
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.047 Action Return Status On Borrowing'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.052 Single Action for Asset Return'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.041 Action Reported Tag'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.043 Submit Report Tag'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.046 Cancel Confirm Reported Tag'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.043 Submit Report Tag'))

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.045 Confirm Reported Tag'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.009 - Return Asset Tag with report tag.png', FailureHandling.STOP_ON_FAILURE)
