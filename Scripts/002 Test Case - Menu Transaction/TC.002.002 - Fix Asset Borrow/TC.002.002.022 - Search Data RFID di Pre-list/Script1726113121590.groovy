...
WebUI.click(findTestObject('00-12 Select Single Scan RFID - Return Borrow'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.022 -  Search Data Pre-list by RFID.png', FailureHandling.STOP_ON_FAILURE)
