...
WebUI.click(findTestObject('OBJ.00 - Fixed Asset - Bulk Action Add Pre-list Borrows/OBJ.027.006 Action Request Borrow'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.009 Action Cancel Borrowing'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.022 - Modul Borrow Transaction/OBJ.022.054 Confirm to contiune Cancel borrowing'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/011. Modul Borrow/TC.002.002.0011 - Cancel Borrowing Request.png', FailureHandling.STOP_ON_FAILURE)
