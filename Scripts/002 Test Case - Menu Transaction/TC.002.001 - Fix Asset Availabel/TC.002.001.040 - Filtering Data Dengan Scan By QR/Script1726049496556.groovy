...
WebUI.click(findTestObject('OBJ.049 - Filtering Data Dengan Fitur Scan/OBJ.049.003 Button QR'))

WebUI.delay(10)

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/010. Register Asset/TC.010.040 - Filtering Data Dengan Fitur Scan QR.png', FailureHandling.STOP_ON_FAILURE)
