...
WebUI.setText(findTestObject('OBJ.010 - Fixed Asset - Register Asset/OBJ.010.002 Search Group for Register'), 'Kantor Pusat Jakarta')
...
WebUI.setText(findTestObject('OBJ.010 - Fixed Asset - Register Asset/OBJ.010.008 Search Asset Name'), 'Lemari Arsip Berkas Admin')
...
WebUI.uploadFile(findTestObject('OBJ.010 - Fixed Asset - Register Asset/OBJ.010.015 Upload Image'), 'C:\\Users\\DELL\\Downloads\\cctv.webp')
...
WebUI.takeScreenshot('Screenshot/010. Register Asset/TC.010.001 - Register Asset Non Tag.png', FailureHandling.STOP_ON_FAILURE)
