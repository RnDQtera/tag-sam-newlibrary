...
WebUI.click(findTestObject('OBJ.049 - Filtering Data Dengan Fitur Scan/OBJ.049.001 Button Search By Scan'))

WebUI.click(findTestObject('OBJ.049 - Filtering Data Dengan Fitur Scan/OBJ.049.002 Button RFID'))

WebUI.delay(10)

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/010. Register Asset/TC.010.039 - Filtering Data Dengan Fitur Scan RFID.png', FailureHandling.STOP_ON_FAILURE)
