...
WebUI.click(findTestObject('OBJ.039 - Fixed Asset - Bulk Action Replace RFID TAG/OBJ.039.001 Checkbox (6)'))

WebUI.click(findTestObject('OBJ.030 - Fixed Asset - Bulk Action Add Pre-list Borrows/OBJ.030.002 Button Bulk Action'))

WebUI.click(findTestObject('OBJ.039 - Fixed Asset - Bulk Action Replace RFID TAG/OBJ.039.002 Bulk Action - Action (9)'))
...
WebUI.takeScreenshot('Screenshot/010. Register Asset/TC.010.029 - Bulk Action Replace RFID TAG.png', FailureHandling.STOP_ON_FAILURE)
