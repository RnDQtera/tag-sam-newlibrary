...
WebUI.click(findTestObject('OBJ.047 - Filtering Data Dengan Field Transactional Policy/OBJ.047.001 Dropdown Transactional Policy'))

WebUI.click(findTestObject('OBJ.047 - Filtering Data Dengan Field Transactional Policy/OBJ.047.002 Chexkbox (2) Non-Transactionable'))

WebUI.click(findTestObject('OBJ.041 - Filtering Data Dengan Field Name/OBJ.041.001 Button Apply'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/010. Register Asset/TC.010.037 - Filtering Data Field Transaction Policy.png', FailureHandling.STOP_ON_FAILURE)
