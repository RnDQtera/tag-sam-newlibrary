...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Action Request Update'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Request Update Date From'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Request Update Date Until'))
...
WebUI.takeScreenshot('Screenshot/012. Asset Transfer/TC.012.024 - Transfer melakukan filtering data berdasarkan field "Request Update".png', 
