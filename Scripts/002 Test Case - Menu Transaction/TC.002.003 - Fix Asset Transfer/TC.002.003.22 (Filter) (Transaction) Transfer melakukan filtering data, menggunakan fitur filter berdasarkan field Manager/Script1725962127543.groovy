...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Button Select Manager'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Checkbox John Doe Manager'))
...
WebUI.takeScreenshot('Screenshot/012. Asset Transfer/TC.012.022 - [Filter] (Transaction) Transfer melakukan filtering data, menggunakan fitur filter berdasarkan field "Manager".png', 
