...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Button Select Group Destination'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Checkbox Kantor Reg Bali'))
...
WebUI.takeScreenshot('Screenshot/012. Asset Transfer/TC.012.020 - [Filter] (Transaction) Transfer melakukan filtering data, menggunakan fitur filter berdasarkan field "Destination".png',
