...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/History Tab/Manager By Transaction'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/History Tab/John Doe Manager - By Transaction'))
