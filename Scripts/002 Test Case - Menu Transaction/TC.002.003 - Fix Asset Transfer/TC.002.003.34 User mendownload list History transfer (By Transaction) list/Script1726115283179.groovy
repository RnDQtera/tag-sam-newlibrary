...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/History Tab/Button Download By Transaction'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/012. Asset Transfer/TC.012.034 - User mendownload list History transfer (By Transaction) list.png', 
