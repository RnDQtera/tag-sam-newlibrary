...
WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Button Select Status'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Checkbox Waiting For Approval'))

WebUI.click(findTestObject('OBJ.024 Modul Transfer/OBJ.024 - Transaction/Button Apply Filter'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/012. Asset Transfer/TC.012.019 - [Filter] (Transaction) Transfer melakukan filtering data, menggunakan fitur filter berdasarkan field "Status".png',
