...
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.022 Clear Field Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.002 Create Field Name'), 'Custom Field Accounting')
...
WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.016 - Create Custom Field Tab Maintenance Routine.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.025 Text Field Search General Information'), 'Custom Field Accounting')
