...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button download asset'))

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.16- User mendownload list data my asset task.png', FailureHandling.STOP_ON_FAILURE)