...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Field manager - task borrow'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.12- Melakukan filtering sesuai dengan field manager.png', FailureHandling.STOP_ON_FAILURE)
