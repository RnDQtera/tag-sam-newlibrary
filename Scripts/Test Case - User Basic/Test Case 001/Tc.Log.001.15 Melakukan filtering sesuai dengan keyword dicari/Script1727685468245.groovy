...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button search'))

WebUI.delay(3)

WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field search'), '0006')

WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field search'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.15- Melakukan filtering sesuai dengan keyword dicari.png', FailureHandling.STOP_ON_FAILURE)