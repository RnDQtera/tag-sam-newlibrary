...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Field request date - task borrow'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.13- Melakukan filtering sesuai dengan field request.png', FailureHandling.STOP_ON_FAILURE)