...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Dropdown Status - Task borrow'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.10- Melakukan filtering dengan field status.png', FailureHandling.STOP_ON_FAILURE)
