...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button cancel assignment'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.02- Melakukan cancel assignment pada asset.png.png', FailureHandling.STOP_ON_FAILURE)
