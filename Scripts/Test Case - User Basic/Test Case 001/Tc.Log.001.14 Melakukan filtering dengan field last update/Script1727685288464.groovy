...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Field last update - task borrow'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.001.14- Melakukan filtering sesuai dengan field last update.png', FailureHandling.STOP_ON_FAILURE)