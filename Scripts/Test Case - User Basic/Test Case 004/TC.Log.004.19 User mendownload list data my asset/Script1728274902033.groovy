...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button download asset - borrowed asset'))

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.19 - User mendownload list data my asset.png', FailureHandling.STOP_ON_FAILURE)
