...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button cancel request'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button Continue cancel menu borrow'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.07 - Melakukan action cancel request.png', FailureHandling.STOP_ON_FAILURE)
