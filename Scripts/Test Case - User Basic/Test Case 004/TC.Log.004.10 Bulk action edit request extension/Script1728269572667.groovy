...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Checkbox list (1) - borrowed asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button bulk action - borrowed asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Bulk action - request extension'))

WebUI.delay(1)

WebUI.clearText(findTestObject('User Basic - My Asset Task Assignment/Field duration day - borrowed asset'))

WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field duration day - borrowed asset'), '3')

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button submit extension request'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.10 - Bulk action edit request extension.png', FailureHandling.STOP_ON_FAILURE)
