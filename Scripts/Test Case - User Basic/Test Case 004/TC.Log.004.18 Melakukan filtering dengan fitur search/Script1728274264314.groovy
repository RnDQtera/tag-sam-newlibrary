...
WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field search - assigned asset'), 'meja kantor')

WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field search - assigned asset'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.18 - Melakukan filtering dengan fitur search.png', FailureHandling.STOP_ON_FAILURE)
