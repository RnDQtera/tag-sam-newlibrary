...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Borrowing log'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.08 - Melakukan pengecekan borrowing log.png', FailureHandling.STOP_ON_FAILURE)
