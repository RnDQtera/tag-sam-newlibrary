...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Checkbox list (2) - borrowed asset'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.004.09 - Bulk action Melakukan extension request.png', FailureHandling.STOP_ON_FAILURE)
