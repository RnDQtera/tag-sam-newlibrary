...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button download asset - assigned asset'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.003.14- User mendownload list data my asset assigned asset.png', FailureHandling.STOP_ON_FAILURE)
