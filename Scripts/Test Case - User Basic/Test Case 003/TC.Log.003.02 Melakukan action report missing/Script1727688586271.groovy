...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button action asset (2) - assigned asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Report missing - assigned asset'))

WebUI.delay(3)

WebUI.sendKeys(findTestObject('User Basic - My Asset Task Assignment/Field enter note - report missing'), 'hilang')
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.003.02- Melakukan action report missing.png', FailureHandling.STOP_ON_FAILURE)
