...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Report damage - assigned asset'))
...
WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.003.01- Melakukan action report damage.png', FailureHandling.STOP_ON_FAILURE)
