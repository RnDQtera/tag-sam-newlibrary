...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Button Select Group History My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Field Select Group History My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Select Group History My Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.04 - Filtering Melakukan filtering data menggunakan fitur filter field Group.png', 
