...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Dropdown Select Module History my Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Field Select Module History my Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.05 - Filtering Melakukan filtering data menggunakan fitur filter field Module.png', 
