...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Dropdown Select Status History My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Field Select Status History My Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.06 - Filtering Melakukan filtering data menggunakan fitur filter field Status.png', 
