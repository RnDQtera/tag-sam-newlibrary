...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Button Download History My Asset'))

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.09 - User mendownload list data my asset history.png', FailureHandling.STOP_ON_FAILURE)
