...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Button Last Update My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Select Last Update My Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.07 - Filtering Melakukan filtering data menggunakan fitur filter field Last Update.png', 
