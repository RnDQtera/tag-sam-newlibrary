...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Dropdown Select Brand History My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Field Select Brand History my Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.02 - Filtering Melakukan filtering data menggunakan fitur filter field Brand.png', 
