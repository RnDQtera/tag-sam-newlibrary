...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Dropdown Model Type History My Asset'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/OBJ 006 History My Asset/Field Model Type History My Asset'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.03 - Filtering Melakukan filtering data menggunakan fitur filter field Model Type.png', 
