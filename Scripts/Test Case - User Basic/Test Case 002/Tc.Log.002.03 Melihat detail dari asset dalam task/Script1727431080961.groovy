...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button menu detail'))

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.002.03- Melihat detail dari asset dalam task.png', FailureHandling.STOP_ON_FAILURE)
