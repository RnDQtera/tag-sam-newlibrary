...
WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button Confirm Hand Over'))

WebUI.delay(2)

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button Confirm menu borrow'))

WebUI.click(findTestObject('User Basic - My Asset Task Assignment/Button Continue menu borrow'))

WebUI.takeScreenshot('Screenshot/User Basic/Tc.Log.002.01- Melakukan action confirmation pada asset.png', FailureHandling.STOP_ON_FAILURE)
