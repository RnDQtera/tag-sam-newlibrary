...
WebUI.clearText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Max Borrowing Time'))

WebUI.delay(5)

WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Max Borrowing Time'), '3')

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/008 Setting Transaction/Button Save Transaction'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.15 - Disposal User mengatur transaction timeout.png', FailureHandling.STOP_ON_FAILURE)
