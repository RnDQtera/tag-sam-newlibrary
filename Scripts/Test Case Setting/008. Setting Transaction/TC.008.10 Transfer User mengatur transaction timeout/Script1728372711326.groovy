...
WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Max Borrowing Time'), '5')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.10 - Transfer User mengatur transaction timeout.png', FailureHandling.STOP_ON_FAILURE)
