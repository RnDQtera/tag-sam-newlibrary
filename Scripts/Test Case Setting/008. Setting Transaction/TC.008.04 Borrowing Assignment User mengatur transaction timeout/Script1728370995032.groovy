...
WebUI.clearText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Transaction Timeout'))

WebUI.delay(5)

WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Transaction Timeout'), '3')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.04 - Borrowing Assignment User mengatur transaction timeout.png', 
