...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/008 Setting Transaction/Searchbox Filter Transaction'), 'transaction')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.08 - Borrowing Assignment filtering data pada table list data changelog field sesuai dengan keyword.png', 
