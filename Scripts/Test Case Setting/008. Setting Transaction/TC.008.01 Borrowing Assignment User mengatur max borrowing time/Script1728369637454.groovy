...
WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Max Borrowing Time'), '4')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.01 -Borrowing Assignment User mengatur max borrowing time.png', 
