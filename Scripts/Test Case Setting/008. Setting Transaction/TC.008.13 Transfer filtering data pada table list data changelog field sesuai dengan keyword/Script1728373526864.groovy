...
WebUI.click(findTestObject('OBJ Menu Setting/008 Setting Transaction/Button Search Filter'))

WebUI.delay(2)

WebUI.sendKeys(findTestObject('OBJ Menu Setting/008 Setting Transaction/Searchbox Filter Transaction'), '15')

WebUI.sendKeys(findTestObject('OBJ Menu Setting/008 Setting Transaction/Searchbox Filter Transaction'), Keys.chord(Keys.ENTER))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.13 - Transfer filtering data pada table list data changelog field sesuai dengan keyword.png', 
