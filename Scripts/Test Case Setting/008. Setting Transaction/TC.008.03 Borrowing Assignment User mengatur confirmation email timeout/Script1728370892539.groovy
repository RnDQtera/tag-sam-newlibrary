...
WebUI.clearText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Confirmation Email Timeout'))

WebUI.delay(5)

WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Confirmation Email Timeout'), '24')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.03 - Borrowing Assignment User mengatur confirmation email timeout.png', 
