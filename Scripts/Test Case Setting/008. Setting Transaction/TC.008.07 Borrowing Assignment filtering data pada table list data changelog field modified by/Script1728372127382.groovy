...
WebUI.click(findTestObject('OBJ Menu Setting/008 Setting Transaction/Button Select User Filter'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/008 Setting Transaction/Select Field 1 User'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/008 Setting Transaction/Button Apply Filter Borrow Assign'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.07 - Borrowing Assignment filtering data pada table list data changelog field modified by.png', 
