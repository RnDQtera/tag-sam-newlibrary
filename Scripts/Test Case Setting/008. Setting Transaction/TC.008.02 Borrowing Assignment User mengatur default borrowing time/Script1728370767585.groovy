...
WebUI.clearText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Default Borrowing Time'))

WebUI.delay(5)

WebUI.setText(findTestObject('OBJ Menu Setting/008 Setting Transaction/Input Default Borrowing Time'), '3')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.02 -Borrowing Assignment User mengatur default borrowing time.png', 
