...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/008 Setting Transaction/Searchbox Filter Transaction'), '20')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.008.23 - Audit filtering data pada table list data changelog field sesuai dengan keyword.png', 
