...
WebUI.click(findTestObject('OBJ Menu Setting/001 Setting Group/Slider 2 Disposal Policy Group'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.001.17 - Bulk action verifikasi mengaktifkan disposal policy group inactive dan active.png', 
