...
WebUI.click(findTestObject('OBJ Menu Setting/001 Setting Group/Action Sub Group'))

WebUI.click(findTestObject('OBJ Menu Setting/001 Setting Group/Action Move Sub Group'))
