...
WebUI.click(findTestObject('OBJ Menu Setting/001 Setting Group/List 1 Sidebar Group'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.001.13 - Single action mengaktifkan Disposal Policy sub group.png', 
