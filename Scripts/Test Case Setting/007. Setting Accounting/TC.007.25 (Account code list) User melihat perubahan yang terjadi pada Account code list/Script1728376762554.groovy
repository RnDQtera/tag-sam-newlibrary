...
//WebUI.delay(2)
//
//WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.007.25 - (Account code list) User melihat perubahan yang terjadi pada Account code list.png', FailureHandling.STOP_ON_FAILURE)
//
