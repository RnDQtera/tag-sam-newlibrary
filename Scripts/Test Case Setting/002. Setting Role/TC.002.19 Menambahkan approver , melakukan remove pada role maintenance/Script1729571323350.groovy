...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.19 - Menambahkan approver pada role maintenance.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.41 - Melakukan action remove approval dari maintenance.png', FailureHandling.STOP_ON_FAILURE)
