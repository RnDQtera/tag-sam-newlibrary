...
WebUI.click(findTestObject('OBJ Menu Setting/002 Setting Role/Button Remove Manager'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.27 - Melakukan action remove manager dari transfer.png', 
