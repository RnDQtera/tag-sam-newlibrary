...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.20 - Menambahkan approver level pada role maintenance.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.38 - Melakukan action remove approval level dari maintenance.png',
