...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.16 - Menambahkan approver level pada role audit.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.34 - Melakukan action remove approval level dari audit.png', FailureHandling.STOP_ON_FAILURE)
