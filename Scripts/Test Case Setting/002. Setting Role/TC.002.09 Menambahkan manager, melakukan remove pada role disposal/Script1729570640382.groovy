...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.09 - Menambahkan role manager disposal.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.31 - Melakukan action remove manager dari disposal.png', FailureHandling.STOP_ON_FAILURE)
