...
WebUI.click(findTestObject('OBJ Menu Setting/002 Setting Role/Tab Transfer'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/002 Setting Role/Button Add Monitoring Report'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.06 - Menambahkan monitor dan report pada role transfer.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.28 - Melakukan action remove monitor report dari transfer.png',
