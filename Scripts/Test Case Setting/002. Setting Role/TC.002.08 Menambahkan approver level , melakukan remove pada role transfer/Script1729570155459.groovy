...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.04 - Menambahkan approver level pada role transfer.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.26 - Melakukan action remove approval level dari transfer.png',
