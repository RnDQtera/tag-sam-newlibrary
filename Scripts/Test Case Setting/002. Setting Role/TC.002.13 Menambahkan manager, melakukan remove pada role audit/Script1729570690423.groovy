...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.13 - Menambahkan role manager audit.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.35 - Melakukan action remove manager dari audit.png', FailureHandling.STOP_ON_FAILURE)
