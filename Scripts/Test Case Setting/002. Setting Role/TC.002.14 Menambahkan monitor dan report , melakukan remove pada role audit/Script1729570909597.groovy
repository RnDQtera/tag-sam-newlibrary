...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.14 - Menambahkan monitor dan report pada role audit.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.002.36 - Melakukan action remove monitor report dari audit.png', FailureHandling.STOP_ON_FAILURE)