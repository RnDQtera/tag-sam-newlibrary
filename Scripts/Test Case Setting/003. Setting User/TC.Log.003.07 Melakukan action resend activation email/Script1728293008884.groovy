...
WebUI.click(findTestObject('OBJ Menu Setting/003 Setting User/Resend action activation email'))
...
WebUI.setText(findTestObject('Object Repository/OBJ Menu Setting/003 Setting User/input_mailbox'), 'indraf')
