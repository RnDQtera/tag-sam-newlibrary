...
WebUI.click(findTestObject('OBJ Menu Setting/003 Setting User/Button cancel email change'))

WebUI.click(findTestObject('OBJ Menu Setting/003 Setting User/Button continue cancel pending email'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.003.11 - Verifikasi user melakukan cancel pada pending email change.png', 
