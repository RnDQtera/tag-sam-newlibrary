...
WebUI.click(findTestObject('OBJ Menu Setting/003 Setting User/Button clear field'))

WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.003.05 - Menghapus semua data pada field create user.png', FailureHandling.STOP_ON_FAILURE)
