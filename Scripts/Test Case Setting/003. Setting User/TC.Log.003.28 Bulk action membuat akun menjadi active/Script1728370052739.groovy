...
//
//WebUI.click(findTestObject('OBJ Menu Setting/003 Setting User/Bulk action - active'))
//
...
//WebUI.delay(2)
//
//WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.003.28 - Bulk action membuat akun menjadi active.png', FailureHandling.STOP_ON_FAILURE)
//
