...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.01 - General Information membuat custom field terbaru.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.02 - General Information mengaktifkan custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.03 - General Information menonaktifkan custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Edit Custom Field 2')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.04 - General Information mengedit custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.05 - General Information menghapus custom field.png', FailureHandling.STOP_ON_FAILURE)
