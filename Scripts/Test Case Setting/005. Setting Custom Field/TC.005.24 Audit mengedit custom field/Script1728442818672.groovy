...
WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Edit Custom Field 2 Audit')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.24 - Audit mengedit custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Search Custom Field'), Keys.chord('Edit Custom Field 2 Audit', 
        Keys.ENTER))
