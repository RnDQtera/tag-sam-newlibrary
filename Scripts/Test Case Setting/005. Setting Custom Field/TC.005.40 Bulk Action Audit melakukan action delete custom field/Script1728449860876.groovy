...
WebUI.click(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Field 3 Data Type'))

WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Value'), 'Value 2')
