...
WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Custom Field Testing 2')
...
WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Custom Currency Testing')
