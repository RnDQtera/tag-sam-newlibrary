...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.17 - Maintenance Routine mengaktifkan custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Required YES'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.19 - Maintenance Routine mengedit custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Search Custom Field'), Keys.chord('Edit Custom Field 2', 
        Keys.ENTER))
