...
WebUI.setText(findTestObject('Object Repository/OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Custom Field 2 Accounting')
...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Search Custom Field'), Keys.chord('Custom Field 2 Accounting', 
        Keys.ENTER))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.13 - Accounting menonaktifkan custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('OBJ Menu Setting/005. Setting Custom Field/Input Text Field Name'), 'Edit Custom Field 2 Accounting')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.14 - Accounting mengedit custom field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.005.15 - Accounting menghapus custom field.png', FailureHandling.STOP_ON_FAILURE)
