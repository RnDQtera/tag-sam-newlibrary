...
WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Dropdown Date Format'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Field 1 Date Time Format'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Button Save General'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.009.03 - User mengatur date format pada general settings.png', FailureHandling.STOP_ON_FAILURE)
