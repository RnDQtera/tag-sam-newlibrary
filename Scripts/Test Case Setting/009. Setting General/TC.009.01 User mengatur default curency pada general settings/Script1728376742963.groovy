...
WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Dropdown Default Currency'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Indonesian Rupiah Currency'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.009.01 - User mengatur default curency pada general settings.png', 
