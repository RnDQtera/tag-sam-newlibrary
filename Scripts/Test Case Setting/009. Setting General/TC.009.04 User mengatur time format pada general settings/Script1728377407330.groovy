...
WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Dropdown Time Format'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.009.04 - User mengatur time format pada general settings.png', FailureHandling.STOP_ON_FAILURE)
