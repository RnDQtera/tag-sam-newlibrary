...
WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Dropdown Time Zone'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/009 Setting General/Asia Jakarta Time'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.009.02 - User mengatur time zone pada general settings.png', FailureHandling.STOP_ON_FAILURE)
