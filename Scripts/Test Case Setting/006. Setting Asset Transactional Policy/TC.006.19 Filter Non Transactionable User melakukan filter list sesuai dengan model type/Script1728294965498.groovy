...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Dropdown Select Model Type'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.006.19 - Filter Non Transactionable User melakukan filter list sesuai dengan model type.png', 
