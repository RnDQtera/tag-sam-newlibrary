...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Dropdown Select Self Service'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.006.13 - Filter Transactionable User melakukan filter list sesuai dengan Self Service.png', 
