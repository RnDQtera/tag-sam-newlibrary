...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/006.01 Tab Transactionable/Action List 1 Transactionable'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/006.01 Tab Transactionable/Action List 2 Transactionable'))
...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/006.01 Tab Transactionable/Bulk Action Mark As Self Service Asset'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.006.06 - Bulk action Transactionable melakukan action Remove from self service asset.png', 
