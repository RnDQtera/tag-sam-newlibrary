...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Dropdown Select Name'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.006.17 - Filter Non Transactionable User melakukan filter list sesuai dengan name.png', 
