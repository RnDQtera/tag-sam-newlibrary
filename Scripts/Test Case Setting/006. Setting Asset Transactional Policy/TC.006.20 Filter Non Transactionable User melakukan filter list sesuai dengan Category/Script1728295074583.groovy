...
WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Button Select Category ATP'))

WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Field 1 Select Category ATP'))

WebUI.click(findTestObject('OBJ Menu Setting/006 Asset Transactional Policy/Select Category ATP'))
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.006.20 - Filter Non Transactionable User melakukan filter list sesuai dengan category.png', 
