...
WebUI.click(findTestObject('OBJ Menu Setting/004 Setting Asset/Button action asset list (2)'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Menu Setting/004 Setting Asset/Action - List (5) - Delete'))
