...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.004.07 - Melakukan category baru.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('OBJ Menu Setting/004 Setting Asset/Field create name category'), 'Kendaraan kantor')
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.004.09 - Melakukan edit category.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.004.11 - Melakukan delete category.png', FailureHandling.STOP_ON_FAILURE)
