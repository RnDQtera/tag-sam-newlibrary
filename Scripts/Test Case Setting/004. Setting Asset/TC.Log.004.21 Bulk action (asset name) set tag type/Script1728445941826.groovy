...
//
//WebUI.click(findTestObject('OBJ Menu Setting/004 Setting Asset/Bulk action - list (2) set tag'))
//
//WebUI.delay(2)
//
...
//WebUI.delay(2)
//
//WebUI.takeScreenshot('Screenshot/017. Menu Setting/TC.004.21 - Bulk action asset name set tag type.png', FailureHandling.STOP_ON_FAILURE)
//
//WebUI.delay(4)
//
