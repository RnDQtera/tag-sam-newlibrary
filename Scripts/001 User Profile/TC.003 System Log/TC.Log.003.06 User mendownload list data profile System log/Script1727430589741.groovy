...
WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button download system log'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.003.06 - User mendownload list data profile System log.png', FailureHandling.STOP_ON_FAILURE)
