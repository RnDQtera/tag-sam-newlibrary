...
WebUI.click(findTestObject('OBJ User Profile/System Log/Button select date system log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Select date system log'))
