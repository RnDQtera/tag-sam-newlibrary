...
WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button select date system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Select date system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button apply system log'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.003.01 - Filtering Melakukan filtering data menggunakan fitur field Date.png', 
