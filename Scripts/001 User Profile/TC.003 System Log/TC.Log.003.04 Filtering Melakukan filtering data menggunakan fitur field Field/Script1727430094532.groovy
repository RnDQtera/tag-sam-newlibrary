...
WebUI.click(findTestObject('OBJ User Profile/System Log/Button select field system log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Select field system log'))
