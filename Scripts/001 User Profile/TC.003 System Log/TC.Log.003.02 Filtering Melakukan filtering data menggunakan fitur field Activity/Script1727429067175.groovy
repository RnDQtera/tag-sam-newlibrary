...
WebUI.click(findTestObject('OBJ User Profile/003 System Log/Tab System Log'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button Filter System Log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button Select activity system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Select activity system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button apply system log'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.003.02 - Filtering Melakukan filtering data menggunakan fitur field Activity.png', 
