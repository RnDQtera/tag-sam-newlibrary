...
WebUI.click(findTestObject('OBJ User Profile/System Log/Tab System Log'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ User Profile/System Log/Button Filter System Log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Button Select activity system log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Select activity system log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Button apply system log'))
