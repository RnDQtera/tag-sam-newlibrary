...
WebUI.click(findTestObject('OBJ User Profile/System Log/Button search system log'))

WebUI.sendKeys(findTestObject('OBJ User Profile/System Log/Searchbox system log'), 'remove')

WebUI.sendKeys(findTestObject('OBJ User Profile/System Log/Searchbox system log'), Keys.chord(Keys.ENTER))
