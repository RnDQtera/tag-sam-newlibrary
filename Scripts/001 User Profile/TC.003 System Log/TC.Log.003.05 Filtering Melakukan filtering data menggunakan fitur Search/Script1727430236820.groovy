...
WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button search system log'))

WebUI.sendKeys(findTestObject('OBJ User Profile/003 System Log/Searchbox system log'), 'remove')

WebUI.sendKeys(findTestObject('OBJ User Profile/003 System Log/Searchbox system log'), Keys.chord(Keys.ENTER))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.003.05 - Filtering Melakukan filtering data menggunakan fitur field search.png', 
