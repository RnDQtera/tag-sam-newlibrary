...
WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button select object system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Select object system log'))

WebUI.click(findTestObject('OBJ User Profile/003 System Log/Button apply system log'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.003.03 - Filtering Melakukan filtering data menggunakan fitur field object.png', 
