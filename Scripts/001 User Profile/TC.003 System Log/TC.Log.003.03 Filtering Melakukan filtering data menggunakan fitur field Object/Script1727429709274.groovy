...
WebUI.click(findTestObject('OBJ User Profile/System Log/Button select object system log'))

WebUI.click(findTestObject('OBJ User Profile/System Log/Select object system log'))
