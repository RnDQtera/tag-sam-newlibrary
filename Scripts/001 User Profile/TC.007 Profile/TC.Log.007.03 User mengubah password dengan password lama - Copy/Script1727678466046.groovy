...
WebUI.sendKeys(findTestObject('OBJ User Profile/Profile/Input Text New Password'), 'Moderator12@')

WebUI.sendKeys(findTestObject('OBJ User Profile/Profile/Input Text Re-enter New Password'), 'Moderator12@')
