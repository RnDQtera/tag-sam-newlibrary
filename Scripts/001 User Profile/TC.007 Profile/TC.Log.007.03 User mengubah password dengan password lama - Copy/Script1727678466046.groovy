...
WebUI.sendKeys(findTestObject('OBJ User Profile/007 Profile/Input Text New Password'), 'Moderator12@')

WebUI.sendKeys(findTestObject('OBJ User Profile/007 Profile/Input Text Re-enter New Password'), 'Moderator12@')
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.007.03 - User mengubah password dengan password lama.png', FailureHandling.STOP_ON_FAILURE)
