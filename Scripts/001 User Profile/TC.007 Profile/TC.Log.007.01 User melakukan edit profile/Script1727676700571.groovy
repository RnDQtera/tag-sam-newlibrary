...
WebUI.clearText(findTestObject('OBJ User Profile/Profile/Input Text Position'))

WebUI.sendKeys(findTestObject('OBJ User Profile/Profile/Input Text Position'), 'QA')
