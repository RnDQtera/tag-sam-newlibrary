...
WebUI.click(findTestObject('OBJ User Profile/007 Profile/Button Edit Profile'))

WebUI.delay(3)

WebUI.clearText(findTestObject('OBJ User Profile/007 Profile/Input Text Email'))

WebUI.sendKeys(findTestObject('OBJ User Profile/007 Profile/Input Text Email'), 'john_abruzzi@mailnesia.com')

WebUI.delay(2)

WebUI.click(findTestObject('OBJ User Profile/007 Profile/Button Save Profile'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ User Profile/007 Profile/Button Continue Edit User'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.007.04 - User mengubah alamat email.png', FailureHandling.STOP_ON_FAILURE)
