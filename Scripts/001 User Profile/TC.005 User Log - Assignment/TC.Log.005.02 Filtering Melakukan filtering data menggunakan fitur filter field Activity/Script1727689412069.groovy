...
WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Filter User Log Assignment'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Select Activity User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Select Activity User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Apply User Log Assign'))

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.005.02 - Filtering Melakukan filtering data menggunakan fitur field Activity.png', 
