...
WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Button Select Activity User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Select Activity User Log Assign'))
