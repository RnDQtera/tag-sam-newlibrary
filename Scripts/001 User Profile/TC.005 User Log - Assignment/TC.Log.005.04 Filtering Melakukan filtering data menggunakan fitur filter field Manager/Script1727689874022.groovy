...
WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Select Manager User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Select Manager User Log Assign'))
