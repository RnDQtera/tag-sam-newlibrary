...
WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Button Select Asset User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Select Asset User Log Assign'))
