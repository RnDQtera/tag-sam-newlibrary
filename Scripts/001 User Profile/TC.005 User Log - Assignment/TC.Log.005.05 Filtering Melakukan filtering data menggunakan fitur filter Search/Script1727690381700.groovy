...
WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Button Search User Log Assignment'))

WebUI.sendKeys(findTestObject('OBJ User Profile/User Log Assignment/Searchbox User Log Assignment'), 'report')

WebUI.sendKeys(findTestObject('OBJ User Profile/User Log Assignment/Searchbox User Log Assignment'), Keys.chord(Keys.ENTER))
