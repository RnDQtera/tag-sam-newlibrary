...
WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Search User Log Assignment'))

WebUI.sendKeys(findTestObject('OBJ User Profile/005 User Log Assignment/Searchbox User Log Assignment'), 'report')

WebUI.sendKeys(findTestObject('OBJ User Profile/005 User Log Assignment/Searchbox User Log Assignment'), Keys.chord(Keys.ENTER))

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.005.05 - Filtering Melakukan filtering data menggunakan fitur Search.png', 
