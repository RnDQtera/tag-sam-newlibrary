...
WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Select Date User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Select Date User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/005 User Log Assignment/Button Apply User Log Assign'))

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.005.01 - Filtering Melakukan filtering data menggunakan fitur field Date.png', 
