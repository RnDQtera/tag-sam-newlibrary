...
WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Button Select Date User Log Assign'))

WebUI.click(findTestObject('OBJ User Profile/User Log Assignment/Select Date User Log Assign'))
