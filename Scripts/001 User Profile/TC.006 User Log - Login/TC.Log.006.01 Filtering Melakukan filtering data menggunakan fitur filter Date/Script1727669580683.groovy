...
WebUI.click(findTestObject('Object Repository/OBJ User Profile/006 User Log Login/Filter/Button Filter User Log Login'))

WebUI.click(findTestObject('Object Repository/OBJ User Profile/006 User Log Login/Filter/Button Select Date User Log Login'))

WebUI.click(findTestObject('Object Repository/OBJ User Profile/006 User Log Login/Filter/Select Date User Log Login'))

WebUI.click(findTestObject('Object Repository/OBJ User Profile/006 User Log Login/Filter/Button Apply Filter User Log Login'))
