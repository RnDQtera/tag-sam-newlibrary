...
WebUI.click(findTestObject('OBJ User Profile/006 User Log Login/Filter/Button Filter User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/006 User Log Login/Filter/Button Select Activity User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/006 User Log Login/Filter/Select Activity User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/006 User Log Login/Filter/Button Apply Filter User Log Login'))

WebUI.delay(4)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.006.02 - Filtering Melakukan filtering data menggunakan fitur filter Activity.png', 
