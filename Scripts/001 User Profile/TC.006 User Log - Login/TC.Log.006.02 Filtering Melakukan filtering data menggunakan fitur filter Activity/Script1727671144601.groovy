...
WebUI.click(findTestObject('OBJ User Profile/User Log Login/Filter/Button Filter User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/User Log Login/Filter/Button Select Activity User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/User Log Login/Filter/Select Activity User Log Login'))

WebUI.click(findTestObject('OBJ User Profile/User Log Login/Filter/Button Apply Filter User Log Login'))
