...
WebUI.click(findTestObject('OBJ User Profile/002 Transaction Role/Filter/Button select role transaction role'))

WebUI.click(findTestObject('OBJ User Profile/002 Transaction Role/Filter/Select role transaction role'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.002.03 - Filtering Melakukan filtering data menggunakan fitur filter Role Name.png', 
