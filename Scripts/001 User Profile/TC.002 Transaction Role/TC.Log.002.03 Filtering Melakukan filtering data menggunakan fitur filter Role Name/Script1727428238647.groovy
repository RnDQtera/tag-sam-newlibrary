...
WebUI.click(findTestObject('OBJ User Profile/Transaction Role/Filter/Button select role transaction role'))

WebUI.click(findTestObject('OBJ User Profile/Transaction Role/Filter/Select role transaction role'))
