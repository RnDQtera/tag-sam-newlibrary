...
WebUI.click(findTestObject('Object Repository/OBJ User Profile/Transaction Role/Filter/Button Select Active Status Transaction Role'))

WebUI.click(findTestObject('Object Repository/OBJ User Profile/Transaction Role/Filter/Select Active Status Transaction Role'))
