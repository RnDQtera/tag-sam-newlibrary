...
WebUI.click(findTestObject('OBJ User Profile/Transaction Role/Filter/Button search tab transaction role'))

WebUI.sendKeys(findTestObject('OBJ User Profile/Transaction Role/Filter/Searchbox tab transaction role'), 'audit')

WebUI.sendKeys(findTestObject('OBJ User Profile/Transaction Role/Filter/Searchbox tab transaction role'), Keys.chord(Keys.ENTER))
