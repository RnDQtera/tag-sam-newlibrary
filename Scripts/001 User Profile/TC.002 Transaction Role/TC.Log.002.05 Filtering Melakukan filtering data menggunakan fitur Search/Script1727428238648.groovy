...
WebUI.click(findTestObject('OBJ User Profile/002 Transaction Role/Filter/Button search tab transaction role'))

WebUI.sendKeys(findTestObject('OBJ User Profile/002 Transaction Role/Filter/Searchbox tab transaction role'), 'audit')

WebUI.sendKeys(findTestObject('OBJ User Profile/002 Transaction Role/Filter/Searchbox tab transaction role'), Keys.chord(Keys.ENTER))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.002.05 - Filtering Melakukan filtering data menggunakan fitur Search.png', 
