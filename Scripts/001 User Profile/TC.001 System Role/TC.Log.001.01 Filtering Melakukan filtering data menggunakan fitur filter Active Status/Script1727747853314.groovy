...
WebUI.click(findTestObject('Object Repository/OBJ User Profile/001 System Role/Button Select Activity Status Group Role'))

WebUI.click(findTestObject('Object Repository/OBJ User Profile/001 System Role/Select Activity Status Group Role'))
