...
WebUI.click(findTestObject('OBJ User Profile/001 System Role/Button Select Group Role'))

WebUI.click(findTestObject('OBJ User Profile/001 System Role/Checkbox Group Role'))

WebUI.click(findTestObject('OBJ User Profile/001 System Role/Select Group Role'))
