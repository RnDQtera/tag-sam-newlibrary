...
WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Button Select Asset Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Select Asset Borrowing'))
