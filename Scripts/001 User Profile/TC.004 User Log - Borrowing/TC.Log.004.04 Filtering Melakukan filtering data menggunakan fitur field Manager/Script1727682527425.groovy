...
WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Button Select Manager Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Select Manager Borrowing'))
...
WebUI.takeScreenshot('Screenshot/016. User Profile/TC.004.04 - Filtering Melakukan filtering data menggunakan fitur field Asset Manager.png', 
