...
WebUI.click(findTestObject('OBJ User Profile/User Log Borrowing/Button Select Manager Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/User Log Borrowing/Select Manager Borrowing'))
