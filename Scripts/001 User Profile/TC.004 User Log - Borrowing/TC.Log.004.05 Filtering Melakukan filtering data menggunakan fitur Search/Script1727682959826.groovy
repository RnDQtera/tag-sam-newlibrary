...
WebUI.click(findTestObject('OBJ User Profile/User Log Borrowing/Button Search Borrowing'))

WebUI.sendKeys(findTestObject('OBJ User Profile/User Log Borrowing/Searchbox Borrowing'), 'return')

WebUI.sendKeys(findTestObject('OBJ User Profile/User Log Borrowing/Searchbox Borrowing'), Keys.chord(Keys.ENTER))
