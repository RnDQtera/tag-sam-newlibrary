...
WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Button Search Borrowing'))

WebUI.sendKeys(findTestObject('OBJ User Profile/004 User Log Borrowing/Searchbox Borrowing'), 'return')

WebUI.sendKeys(findTestObject('OBJ User Profile/004 User Log Borrowing/Searchbox Borrowing'), Keys.chord(Keys.ENTER))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.004.05 - Filtering Melakukan filtering data menggunakan fitur Search.png', 
