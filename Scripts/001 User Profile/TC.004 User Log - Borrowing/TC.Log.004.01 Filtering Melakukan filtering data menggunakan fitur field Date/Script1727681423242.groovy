...
WebUI.click(findTestObject('OBJ User Profile/User Log Borrowing/Button Select Date Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/User Log Borrowing/Select Date Borrowing'))
