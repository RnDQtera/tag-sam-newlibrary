...
WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Button Select Date Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Select Date Borrowing'))

WebUI.click(findTestObject('OBJ User Profile/004 User Log Borrowing/Button Apply Borrowing'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/016. User Profile/TC.004.01 - Filtering Melakukan filtering data menggunakan fitur field Date.png', 
