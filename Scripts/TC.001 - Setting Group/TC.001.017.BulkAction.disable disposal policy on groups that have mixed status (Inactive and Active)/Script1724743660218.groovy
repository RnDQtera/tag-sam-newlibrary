...
WebUI.click(findTestObject('OBJ.001 - Setting Group/0038 Choice Inactive Disposal Policy'))

WebUI.takeScreenshot('[Bulk Action Disposal Policy Groups have mixed Status .png', FailureHandling.STOP_ON_FAILURE)
