...
WebUI.setText(findTestObject('OBJ.001 - Setting Group/0007 Field New Group Name'), 'Kantor Regional JaTim')
...
WebUI.takeScreenshot('Create New Group.png', FailureHandling.STOP_ON_FAILURE)
