...
WebUI.click(findTestObject('OBJ.001 - Setting Group/0039 Button Search'))

WebUI.setText(findTestObject('OBJ.001 - Setting Group/0040 Fields Input Search'), 'Kantor Pusat Jakarta')
