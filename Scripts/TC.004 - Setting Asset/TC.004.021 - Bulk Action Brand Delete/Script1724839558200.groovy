...
WebUI.setText(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.059 Enter New Brand Name'), 'Olympic Add New')
...
WebUI.setText(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.099 Search Category'), 'Furnitur dan Aksesori')
...
WebUI.setText(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.072 Text Field Data Table'), Keys.chord('Olympic Add New', 
        Keys.ENTER))
...
WebUI.takeScreenshot('Screenshot/TC.004.021-Bulk Delete Brand.png', FailureHandling.STOP_ON_FAILURE)
