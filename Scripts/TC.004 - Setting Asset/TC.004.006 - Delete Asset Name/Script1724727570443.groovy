...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.030 Set Tag Type'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.033 Clear Field Tag Type'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.035 Confirm Cancel Change Tag Type'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.004.006-Set Tag Type.png', FailureHandling.STOP_ON_FAILURE)
