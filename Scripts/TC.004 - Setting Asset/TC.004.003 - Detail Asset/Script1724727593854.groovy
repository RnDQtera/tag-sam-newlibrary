...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.021 Select Detail Asset Name'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.004.003-Detail Asset.png', FailureHandling.STOP_ON_FAILURE)
