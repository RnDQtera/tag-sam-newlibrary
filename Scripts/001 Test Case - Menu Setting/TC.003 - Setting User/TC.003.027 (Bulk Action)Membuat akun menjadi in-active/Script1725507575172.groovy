...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.082 Bulk action - Button InActive - Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.084 Button inactive - inactive user - Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.014 Button Change Log'))

WebUI.delay(3)

WebUI.takeScreenshot('Screenshot/TC.003.027 - Membuat akun menjadi inactive.png', FailureHandling.STOP_ON_FAILURE)
