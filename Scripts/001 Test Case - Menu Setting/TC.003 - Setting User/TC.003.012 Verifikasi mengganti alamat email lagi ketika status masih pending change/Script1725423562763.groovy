...
WebUI.clearText(findTestObject('OBJ.003 - Setting User/OBJ.003.049 Field Email (2) (Fajar) - Copy'))

WebUI.delay(2)

WebUI.setText(findTestObject('OBJ.003 - Setting User/OBJ.003.049 Field Email (2) (Fajar) - Copy'), 'fajar3@mailnesia.com')
...
WebUI.takeScreenshot('Screenshot/TC.003.012- Verifikasi mengganti alamat email ketika status pending.png', FailureHandling.STOP_ON_FAILURE)
