...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.066 Slider User (2) (Fajar) - Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.014 Button Change Log'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/TC.003.016- Mengnonaktifkan user.png', FailureHandling.STOP_ON_FAILURE)
