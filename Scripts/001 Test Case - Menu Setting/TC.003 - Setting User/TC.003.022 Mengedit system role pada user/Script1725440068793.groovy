...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.069 Button Edit System Role - Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.022- Mengedit system role pada user.png', FailureHandling.STOP_ON_FAILURE)
