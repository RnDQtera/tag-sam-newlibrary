...
WebUI.setText(findTestObject('OBJ.003 - Setting User/OBJ.003.053 Field Email User (4) (Rizky ) - Copy'), 'rizky1@mailnesia.com')
...
WebUI.takeScreenshot('Screenshot/TC.003.009- User mengganti alamat email dan verifikasi akun .png', FailureHandling.STOP_ON_FAILURE)

WebUI.delay(5)

WebUI.openBrowser('mailnesia.com')

WebUI.setText(findTestObject('OBJ.003 - Setting User/OBJ.003.039 Field mailbox'), 'rizky1')

WebUI.sendKeys(findTestObject('OBJ.003 - Setting User/OBJ.003.039 Field mailbox'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.054 Click Mail Baru - Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.055 Button Confirm Email - Copy'))
