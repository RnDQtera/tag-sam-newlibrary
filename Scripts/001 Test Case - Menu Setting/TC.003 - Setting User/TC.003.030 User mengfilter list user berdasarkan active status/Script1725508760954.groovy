...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.086 klik field active - Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.030 - User mengfilter berdasarkan active status.png', FailureHandling.STOP_ON_FAILURE)
