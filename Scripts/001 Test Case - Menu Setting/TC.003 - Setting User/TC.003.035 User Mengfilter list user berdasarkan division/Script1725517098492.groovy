...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.096 Klik field division Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.035 - User mengfilter berdasarkan division.png', FailureHandling.STOP_ON_FAILURE)
