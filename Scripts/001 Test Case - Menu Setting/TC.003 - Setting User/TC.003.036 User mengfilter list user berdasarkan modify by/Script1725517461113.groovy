...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.097 Klik field modified by - Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.036 - User mengfilter berdasarkan modify by.png', FailureHandling.STOP_ON_FAILURE)
