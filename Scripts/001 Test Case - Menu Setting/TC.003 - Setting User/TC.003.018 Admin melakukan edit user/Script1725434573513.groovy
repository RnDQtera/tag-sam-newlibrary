...
WebUI.clearText(findTestObject('OBJ.003 - Setting User/OBJ.003.006 Field Phone Number'))

WebUI.setText(findTestObject('OBJ.003 - Setting User/OBJ.003.006 Field Phone Number'), '123456789')
...
WebUI.takeScreenshot('Screenshot/TC.003.018- Admin melakukan edit user.png', FailureHandling.STOP_ON_FAILURE)
