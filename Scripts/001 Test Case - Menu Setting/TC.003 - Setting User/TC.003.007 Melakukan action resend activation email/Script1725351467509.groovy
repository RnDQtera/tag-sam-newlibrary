...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.046 Button resend activation email'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.047 Button Resend'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/TC.003.007- Action resend activation email.png', FailureHandling.STOP_ON_FAILURE)
