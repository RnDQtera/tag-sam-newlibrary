...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.102 Button Downliad User Copy'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/TC.003.039 - User mendownload list user.png', FailureHandling.STOP_ON_FAILURE)
