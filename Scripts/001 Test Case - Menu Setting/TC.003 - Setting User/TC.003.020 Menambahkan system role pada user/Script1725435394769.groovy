...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.021 Checkbox Kantor Pusat Jakarta'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.021 Button Select (Group)'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.025 Dropdown System Role'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.022 Checkbox System Role (1)'))
...
WebUI.takeScreenshot('Screenshot/TC.003.020- Menambahkan system role pada user.png', FailureHandling.STOP_ON_FAILURE)
