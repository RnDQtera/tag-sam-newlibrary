...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.083 Bulk action - Button Delete Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.029 - Menghapus akun.png', FailureHandling.STOP_ON_FAILURE)
