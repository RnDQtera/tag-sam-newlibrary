...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.066 Select All Category'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.067 Select Action for bulk action'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.068 Delete bulk action'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.069 Clear Field Create Brand'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.004.011 - Create New Brand.png', FailureHandling.STOP_ON_FAILURE)
