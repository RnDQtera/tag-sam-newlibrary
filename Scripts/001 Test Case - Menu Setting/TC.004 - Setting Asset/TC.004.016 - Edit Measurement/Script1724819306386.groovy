...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.090 Choose Edit Measurement'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.082 Text Field Create Measurement'), 'Ons Edited')

WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.084 Submit add new Measurement'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/TC.004.016 - Edit Measurement.png', FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.086 Text Field Search Data Measurement'), Keys.chord(
        Keys.CONTROL, 'a', Keys.DELETE))

WebUI.setText(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.086 Text Field Search Data Measurement'), 'Ons Edited')
