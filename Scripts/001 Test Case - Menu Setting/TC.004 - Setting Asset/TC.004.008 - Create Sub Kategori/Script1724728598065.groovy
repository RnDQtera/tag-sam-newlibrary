...
WebUI.click(findTestObject('OBJ.004 - Setting Asset Name/OBJ.004.047 Show Open Hirarki Category'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/TC.004.008 - Create Sub Kategori.png', FailureHandling.STOP_ON_FAILURE)
