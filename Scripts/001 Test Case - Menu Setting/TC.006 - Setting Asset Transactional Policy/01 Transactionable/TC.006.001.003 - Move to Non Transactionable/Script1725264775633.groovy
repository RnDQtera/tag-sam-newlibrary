...
WebUI.click(findTestObject('OBJ.006 - Setting Asset Transactional Policy/OBJ.006.028 Move to Non Transactionable Single Action'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/006.Asset Transactional Policy/TC.006.003 - Move to non Transactionable.png', FailureHandling.STOP_ON_FAILURE)
