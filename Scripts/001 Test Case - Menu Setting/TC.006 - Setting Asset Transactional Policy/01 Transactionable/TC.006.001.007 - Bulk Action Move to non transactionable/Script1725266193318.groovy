...
WebUI.click(findTestObject('OBJ.006 - Setting Asset Transactional Policy/OBJ.006.027 Move to Non Transactionable Bulk Action'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/006.Asset Transactional Policy/TC.006.005 - Bulk Action Mark as self service Asset.png', 
    FailureHandling.STOP_ON_FAILURE)
