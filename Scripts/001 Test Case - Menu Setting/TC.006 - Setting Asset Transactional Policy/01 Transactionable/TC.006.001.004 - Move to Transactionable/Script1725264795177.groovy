...
WebUI.click(findTestObject('OBJ.006 - Setting Asset Transactional Policy/OBJ.006.029 Single Action Sub Tab Non Transactionable'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.006 - Setting Asset Transactional Policy/OBJ.006.030 Single Action Move to Teransactionable'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/006.Asset Transactional Policy/TC.006.004 - Move to Transactionable.png', FailureHandling.STOP_ON_FAILURE)
