...
//
//WebUI.delay(8, FailureHandling.STOP_ON_FAILURE)
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.031 Sub Tab Purchase'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.001 Add Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.002 Create Field Name'), 'Custom Field Purchase')
...
WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.009 -Edit Custom Field Purchase.png', FailureHandling.STOP_ON_FAILURE)
