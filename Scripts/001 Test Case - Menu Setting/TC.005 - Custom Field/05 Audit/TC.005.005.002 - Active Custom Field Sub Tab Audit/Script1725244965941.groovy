...
'Non Aktif Custom Field\r\n'
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.030 Active and Deactive Custom Field'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.0022 - Active And Deactive Custom Field Tab Audit.png', FailureHandling.STOP_ON_FAILURE)
