...
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.037 Choose Active or Inactive Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.039 Cancel Active or Inactive Custom Field'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.038 Confirm Active or Inactive Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.030 - Active or Inactive Data Custom Field.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.025 Text Field Search General Information'), Keys.chord(
        Keys.ENTER))
