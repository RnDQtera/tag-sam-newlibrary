...
WebUI.click(findTestObject('OBJ.002 - Setting Role/OBJ.002.031 Button Trash(Remove) Approver (2)'))
...
WebUI.takeScreenshot('Screenshot/TC.002.026 - Remove Approval Level - Borrowing.png', FailureHandling.STOP_ON_FAILURE)
