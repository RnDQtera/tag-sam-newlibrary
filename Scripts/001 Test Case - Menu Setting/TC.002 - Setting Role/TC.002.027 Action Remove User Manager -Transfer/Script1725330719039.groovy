...
WebUI.click(findTestObject('OBJ.002 - Setting Role/OBJ.002.036 Button x Manajer (2)'))
...
WebUI.takeScreenshot('Screenshot/TC.002.027 - Remove Remove User Manager - Transfer.png', FailureHandling.STOP_ON_FAILURE)
