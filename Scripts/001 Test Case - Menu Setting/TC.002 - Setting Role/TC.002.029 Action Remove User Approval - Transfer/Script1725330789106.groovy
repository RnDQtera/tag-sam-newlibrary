...
WebUI.click(findTestObject('OBJ.002 - Setting Role/OBJ.002.035 Button x Approver (1)'))
...
WebUI.takeScreenshot('Screenshot/TC.002.029 - Action Remove User Approval - Transfer.png', FailureHandling.STOP_ON_FAILURE)
