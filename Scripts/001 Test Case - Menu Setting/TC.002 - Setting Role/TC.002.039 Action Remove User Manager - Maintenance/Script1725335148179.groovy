...
WebUI.click(findTestObject('OBJ.002 - Setting Role/OBJ.002.033 Button x Manager (1)'))
...
WebUI.takeScreenshot('Screenshot/TC.002.039 - Action Remove Approval Level - Maintenance.png', FailureHandling.STOP_ON_FAILURE)
