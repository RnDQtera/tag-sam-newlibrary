...
WebUI.click(findTestObject('OBJ.002 - Setting Role/OBJ.002.034 Button X Monitor (2)'))
...
WebUI.takeScreenshot('Screenshot/TC.002.040 - Action Remove User Monitor - Maintenance.png', FailureHandling.STOP_ON_FAILURE)
