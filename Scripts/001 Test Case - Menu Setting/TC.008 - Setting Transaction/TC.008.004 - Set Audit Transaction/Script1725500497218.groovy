...
//
//WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)
WebUI.click(findTestObject('OBJ.008 - Setting Transaction/004. Audit/OBJ.008.004.001 Sub Tab Audit'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.020 - Save Time Audit Transaction.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.021 - Search Data FIlter Audit Transaction.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.022 -Change log filter date Audit Transaction.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.023 - Change Log Filter Modified By.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.0124 - Download Data Change Log.png', FailureHandling.STOP_ON_FAILURE)
