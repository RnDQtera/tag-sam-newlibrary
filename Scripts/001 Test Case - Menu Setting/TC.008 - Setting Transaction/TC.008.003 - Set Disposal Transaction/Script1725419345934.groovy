...
WebUI.click(findTestObject('OBJ.008 - Setting Transaction/003. Disposal/OBJ.008.003.001 Sub Tab Disposal'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.015 - Save Time Disposal Transaction.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.016 - Search Data FIlter Disposal Transaction.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.017 -Change log filter date Disposal Transaction.png', 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.018 - Change Log Filter Modified By.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/008. Transaction Setting/TC.008.019 - Download Data Change Log.png', FailureHandling.STOP_ON_FAILURE)
