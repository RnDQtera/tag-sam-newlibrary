...
WebUI.click(findTestObject('OBJ.007. - Setting Accounting/OBJ.001.025 Clear Field'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/007.Accounting Setting/TC.007.005 - Create Account Code List.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.007. - Setting Accounting/OBJ.001.033 Cancel Delete'), FailureHandling.STOP_ON_FAILURE)
