...
WebUI.click(findTestObject('OBJ.007. - Setting Accounting/OBJ.001.004 Clear Field'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/007.Accounting Setting/TC.007.001 - Create Depreciation Group.png', FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('OBJ.007. - Setting Accounting/OBJ.001.011 Cancel Confirm Delete'), FailureHandling.STOP_ON_FAILURE)
