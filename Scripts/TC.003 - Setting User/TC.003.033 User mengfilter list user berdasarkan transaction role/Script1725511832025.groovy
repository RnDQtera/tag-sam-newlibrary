...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.094 Klik field transaction role Copy'))
...
WebUI.takeScreenshot('Screenshot/TC.003.033 - User mengfilter berdasarkan transaction role.png', FailureHandling.STOP_ON_FAILURE)
