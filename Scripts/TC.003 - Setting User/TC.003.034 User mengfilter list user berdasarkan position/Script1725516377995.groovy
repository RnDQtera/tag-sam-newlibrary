...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.095 Klik field position- Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.087 checkbox field (1) Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.088 checkbox field(2) Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.089 Button Apply - Copy'))

WebUI.delay(4)

WebUI.takeScreenshot('Screenshot/TC.003.034 - User mengfilter berdasarkan position.png', FailureHandling.STOP_ON_FAILURE)
