...
WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.093 Klik field system role Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.091 Checkbox field(3) - Copy'))

WebUI.click(findTestObject('OBJ.003 - Setting User/OBJ.003.089 Button Apply - Copy'))

WebUI.delay(4)

WebUI.takeScreenshot('Screenshot/TC.003.032 - User mengfilter berdasarkan system role.png', FailureHandling.STOP_ON_FAILURE)
