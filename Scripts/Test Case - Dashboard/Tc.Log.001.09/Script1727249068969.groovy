...
WebUI.click(findTestObject('OBJ Dashboard/Menu Damage'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.09 - User masuk halaman fixed asset damage.png', FailureHandling.STOP_ON_FAILURE)
