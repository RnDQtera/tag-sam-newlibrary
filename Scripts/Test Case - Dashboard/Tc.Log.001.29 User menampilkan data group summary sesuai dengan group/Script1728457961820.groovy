...
WebUI.click(findTestObject('OBJ Dashboard/Kantor Regional Bali'))

WebUI.click(findTestObject('OBJ Dashboard/Button Select'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.29 - User menampilkan data group summary sesuai dengan group.png', FailureHandling.STOP_ON_FAILURE)
