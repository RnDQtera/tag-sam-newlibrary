...
WebUI.click(findTestObject('OBJ Dashboard/Menu Plus Audit'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.04 - User masuk halaman fixed asset +audit.png', FailureHandling.STOP_ON_FAILURE)
