...
WebUI.click(findTestObject('OBJ Dashboard/Menu Borrow'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.01 - User masuk halaman fixed asset borrow.png', FailureHandling.STOP_ON_FAILURE)
