...
WebUI.click(findTestObject('OBJ Dashboard/Menu Tagging'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.11 - User masuk halaman fixed asset tagging.png', FailureHandling.STOP_ON_FAILURE)
