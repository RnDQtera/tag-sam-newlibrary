...
WebUI.click(findTestObject('OBJ Dashboard/Select Time Interval - Last Year'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.25 - User menampilkan data user summary sesuai dengan group dan time interval Last Year.png',
