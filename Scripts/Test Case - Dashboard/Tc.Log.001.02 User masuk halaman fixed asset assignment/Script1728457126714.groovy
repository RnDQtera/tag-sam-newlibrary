...
WebUI.click(findTestObject('OBJ Dashboard/Menu Assignment'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.02 - User masuk halaman fixed asset assignment.png', FailureHandling.STOP_ON_FAILURE)
