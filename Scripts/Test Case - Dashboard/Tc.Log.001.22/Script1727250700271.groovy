...
WebUI.click(findTestObject('OBJ Dashboard/Select Time Interval - Today'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.22 - User menampilkan data user summary sesuai dengan group dan time interval Today.png', FailureHandling.STOP_ON_FAILURE)
