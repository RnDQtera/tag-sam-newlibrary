...
WebUI.click(findTestObject('OBJ Dashboard/Menu Transfer'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.03 - User masuk halaman fixed asset transfer.png', FailureHandling.STOP_ON_FAILURE)
