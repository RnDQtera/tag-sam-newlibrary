...
WebUI.click(findTestObject('OBJ Dashboard/Menu Plus Tracking'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.05 - User masuk halaman fixed asset +tracking.png', FailureHandling.STOP_ON_FAILURE)
