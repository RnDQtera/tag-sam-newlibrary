...
WebUI.click(findTestObject('OBJ Dashboard/Select Time Interval - Last Month'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.24 - User menampilkan data user summary sesuai dengan group dan time interval Last Month.png', 
