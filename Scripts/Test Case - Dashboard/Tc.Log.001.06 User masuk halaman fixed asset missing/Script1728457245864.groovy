...
WebUI.click(findTestObject('OBJ Dashboard/Menu Missing'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.06 - User masuk halaman fixed asset missing.png', FailureHandling.STOP_ON_FAILURE)
