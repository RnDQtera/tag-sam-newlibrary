...
WebUI.click(findTestObject('OBJ Dashboard/Menu Plus Repair Ticketing'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.08 - User masuk halaman fixed asset +repair ticketing.png', FailureHandling.STOP_ON_FAILURE)
