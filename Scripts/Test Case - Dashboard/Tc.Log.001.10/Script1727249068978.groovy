...
WebUI.click(findTestObject('OBJ Dashboard/Menu Disposal'))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.10 - User masuk halaman fixed asset disposal.png', FailureHandling.STOP_ON_FAILURE)
