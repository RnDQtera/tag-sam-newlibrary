...
WebUI.click(findTestObject('OBJ Dashboard/Kantor Pusat Jakarta'))
...
WebUI.click(findTestObject('OBJ Dashboard/Select Time Interval - Last 7 Day'))

WebUI.delay(1)

WebUI.takeScreenshot('Screenshot/Dashboard/TC.001.23 - User menampilkan data user summary sesuai dengan group dan time interval Last 7 Day.png', FailureHandling.STOP_ON_FAILURE)
