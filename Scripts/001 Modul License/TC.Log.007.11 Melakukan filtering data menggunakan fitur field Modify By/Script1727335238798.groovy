...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button select user changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Select user changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button apply changelog tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.11 - Melakukan filtering data menggunakan fitur field modify by.png', 
