...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Button show child group repair ticketing'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.14 - User menampilkan child group data.png', FailureHandling.STOP_ON_FAILURE)
