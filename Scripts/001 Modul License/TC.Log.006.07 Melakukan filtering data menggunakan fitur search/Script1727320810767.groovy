...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Filter repair ticketing/Button Search tab repair ticketing'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Repair Ticketing/Filter repair ticketing/Searchbox repair ticketing'), 
    'active')
...
WebUI.takeScreenshot('Screenshot/015. License/TC.006.07 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
