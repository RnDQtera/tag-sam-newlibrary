...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Fixed Asset'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.08 - Melakukan filter Menampilkan Data Sesuai Field Fixed Asset.png', 
