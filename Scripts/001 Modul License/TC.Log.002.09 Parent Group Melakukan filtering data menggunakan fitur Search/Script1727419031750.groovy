...
WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button search tab allocation'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Allocation/Searchbox tab allocation'), 'not set')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Allocation/Searchbox tab allocation'), Keys.chord(Keys.ENTER))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.002.09 - Parent Group Melakukan filtering data menggunakan fitur search.png', 
