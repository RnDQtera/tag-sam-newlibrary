...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Button select expired date existing tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Select expired date existing tab'))
