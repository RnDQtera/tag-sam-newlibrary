...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Select tag'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Checkbox select tag'))
