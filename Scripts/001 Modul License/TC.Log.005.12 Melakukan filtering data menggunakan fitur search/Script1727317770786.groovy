...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button search'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Searchbox'), 'Lamborghini')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Searchbox'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.12 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
