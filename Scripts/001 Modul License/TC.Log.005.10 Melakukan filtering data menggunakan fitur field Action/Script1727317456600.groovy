...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button select action'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Select action'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.10 - Melakukan filtering data menggunakan fitur field Action.png', 
