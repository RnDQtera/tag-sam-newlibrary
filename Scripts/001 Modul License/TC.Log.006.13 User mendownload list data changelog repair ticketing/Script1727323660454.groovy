...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button download changelog repair ticketing'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.13 - User mendowload list data changelog repair ticketing.png', FailureHandling.STOP_ON_FAILURE)
