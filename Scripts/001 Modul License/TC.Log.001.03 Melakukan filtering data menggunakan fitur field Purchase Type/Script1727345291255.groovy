...
WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button select purchase existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Select purchase existing tab'))
