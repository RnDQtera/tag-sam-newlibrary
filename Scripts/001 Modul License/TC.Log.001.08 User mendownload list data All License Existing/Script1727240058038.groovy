...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Button Download List Existing'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.08 - User mendownload list data All License Existing.png', FailureHandling.STOP_ON_FAILURE)
