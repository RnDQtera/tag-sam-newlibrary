...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Tab repair ticketing'))

WebUI.delay(5)

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button changelog repair ticketing'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button filter changelog repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button select date changelog repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Select date repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button apply repair ticketing'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.09 - Melakukan filtering data menggunakan fitur field Date.png', FailureHandling.STOP_ON_FAILURE)
