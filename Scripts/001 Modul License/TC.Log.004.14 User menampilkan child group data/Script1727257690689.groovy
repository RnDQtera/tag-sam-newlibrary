...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Tab Audit'))

WebUI.delay(5)

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Button Show Child group'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.14 - User menampilkan child group data.png', FailureHandling.STOP_ON_FAILURE)
