...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Button search expired tab'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Searchbox expired tab'), 'asset')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Searchbox expired tab'), Keys.chord(Keys.ENTER))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.15 - Expired Melakukan filtering data menggunakan fitur search.png', 
