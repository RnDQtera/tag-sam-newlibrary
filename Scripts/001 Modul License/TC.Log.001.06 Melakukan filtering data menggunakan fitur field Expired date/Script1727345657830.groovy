...
WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button select expired date existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Select expired date existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button apply existing tab'))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.06 - Melakukan filtering data menggunakan fitur filter, menampilkan data sesuai dengan field Expired date.png', 
