...
WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button search existing tab'))

WebUI.delay(2)

WebUI.sendKeys(findTestObject('OBJ Modul License/All Licenses Tab/Searchbox existing tab'), 'asset')

WebUI.sendKeys(findTestObject('OBJ Modul License/All Licenses Tab/Searchbox existing tab'), Keys.chord(Keys.ENTER))
