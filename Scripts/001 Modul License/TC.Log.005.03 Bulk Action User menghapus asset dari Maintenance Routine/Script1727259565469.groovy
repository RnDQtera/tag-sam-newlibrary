...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Button bulk action tab maintenance'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Bulk action remove from addon'))
