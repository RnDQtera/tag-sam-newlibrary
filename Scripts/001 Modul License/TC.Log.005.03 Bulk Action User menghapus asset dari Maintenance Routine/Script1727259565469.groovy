...
WebUI.click(findTestObject('OBJ Modul License/Maintenance Tab/Button bulk action tab maintenance'))

WebUI.click(findTestObject('OBJ Modul License/Maintenance Tab/Bulk action remove from addon'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.005.03 - Bulk Action User menghapus asset dari Maintenance Routine.png', 
