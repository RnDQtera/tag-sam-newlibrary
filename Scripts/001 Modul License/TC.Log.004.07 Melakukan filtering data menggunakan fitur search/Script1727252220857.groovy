...
WebUI.sendKeys(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Searchbox tab audit'), 'Lambo')

WebUI.sendKeys(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Searchbox tab audit'), Keys.chord(Keys.ENTER))
