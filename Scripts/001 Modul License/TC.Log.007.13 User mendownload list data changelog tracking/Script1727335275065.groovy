...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button download changelog tracking'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.13 - User mendowload list data changelog repair ticketing.png', FailureHandling.STOP_ON_FAILURE)
