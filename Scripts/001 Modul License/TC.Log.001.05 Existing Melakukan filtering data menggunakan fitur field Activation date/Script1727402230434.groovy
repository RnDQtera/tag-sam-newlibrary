...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Button select activation date existing tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Select activation date existing tab'))
