...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button select user'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Select user'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.11 - Melakukan filtering data menggunakan fitur field Modify By.png', 
