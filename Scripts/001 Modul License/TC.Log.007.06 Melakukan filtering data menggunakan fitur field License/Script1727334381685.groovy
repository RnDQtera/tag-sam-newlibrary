...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Button select license tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Select license tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Button apply tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.06 - Melakukan filtering data menggunakan fitur field license.png', 
