...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Filter repair ticketing/Button download repair ticketing'))

WebUI.delay(8)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.08 - User mendownload list data repair ticketing.png', FailureHandling.STOP_ON_FAILURE)
