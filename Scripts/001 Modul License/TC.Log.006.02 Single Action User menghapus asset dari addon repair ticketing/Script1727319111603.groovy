...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Checkbox select asset tab repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Button action tab repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Single action remove from addon'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Submit remove from addon'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.006.02 - Single Action User menghapus asset dari addon repair ticketing.png', 
