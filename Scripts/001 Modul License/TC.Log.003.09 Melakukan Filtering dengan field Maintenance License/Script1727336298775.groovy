...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Field Maintenance License'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.09 - Melakukan filter Menampilkan Data Sesuai Field Maintenance License.png',
