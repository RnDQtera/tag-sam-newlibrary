...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button search changelog repair ticketing'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Searchbox changelog repair ticketing'), 
    'add')
...
WebUI.takeScreenshot('Screenshot/015. License/TC.006.12 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
