...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button filter'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button select date'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Select date'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.09 - Melakukan filtering data menggunakan fitur field Date.png', FailureHandling.STOP_ON_FAILURE)
