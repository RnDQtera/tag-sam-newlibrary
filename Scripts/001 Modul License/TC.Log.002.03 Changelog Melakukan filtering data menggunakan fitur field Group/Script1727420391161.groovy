...
WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Button select group changelog allocation'))

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Select group changelog allocation'))

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Button apply changelog allocation'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.002.03 - Changelog Melakukan filtering data menggunakan fitur field Group.png', 
