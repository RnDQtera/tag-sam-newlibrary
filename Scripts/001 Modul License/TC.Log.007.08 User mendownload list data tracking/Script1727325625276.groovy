...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Button download tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.08 - User mendownload list data tracking.png', FailureHandling.STOP_ON_FAILURE)
