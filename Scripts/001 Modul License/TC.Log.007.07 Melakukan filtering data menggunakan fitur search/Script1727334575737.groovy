...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Button search tracking'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Searchbox tracking'), 'lambo')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Searchbox tracking'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.07 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
