...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Button select name tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Select name tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Tracking Filter/Button apply tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.04 - Melakukan filtering data menggunakan fitur field Name.png', FailureHandling.STOP_ON_FAILURE)
