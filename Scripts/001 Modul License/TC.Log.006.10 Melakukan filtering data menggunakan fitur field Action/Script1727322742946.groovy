...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button Select action repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Select action repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button apply repair ticketing'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.10 - Melakukan filtering data menggunakan fitur field action.png', 
