...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button select tag'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Select tag'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.05 - Melakukan filtering data menggunakan fitur field Tag.png', FailureHandling.STOP_ON_FAILURE)
