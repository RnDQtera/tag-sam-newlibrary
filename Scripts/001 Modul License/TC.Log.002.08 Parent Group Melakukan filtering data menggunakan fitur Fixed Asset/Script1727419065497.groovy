...
WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button filter tab allocation'))

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button select fix asset tab allocation'))

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Field 1 select fix asset tab allocation'))

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button apply tab allocation'))

WebUI.delay(8)

WebUI.takeScreenshot('Screenshot/015. License/TC.002.08 - Parent Group Melakukan filtering data menggunakan fitur Fixed Asset.png', FailureHandling.STOP_ON_FAILURE)
