...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Button select modul existing tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Select modul existing tab'))
