...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button select user repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Select user repair ticketing'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Changelog/Button apply repair ticketing'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.11 - Melakukan filtering data menggunakan fitur field modify by.png', 
