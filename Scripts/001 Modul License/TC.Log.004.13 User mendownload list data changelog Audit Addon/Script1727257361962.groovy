...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button download changelog'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.13 - User mendownload list data changelog Audit Addon.png', FailureHandling.STOP_ON_FAILURE)
