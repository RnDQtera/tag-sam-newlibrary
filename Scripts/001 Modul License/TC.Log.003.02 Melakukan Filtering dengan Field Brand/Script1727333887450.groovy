...
WebUI.click(findTestObject('OBJ Modul License/Asset Tab/Dropdown Field Brand'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.02 - Melakukan filter Menampilkan Data Sesuai Field Brand.png', FailureHandling.STOP_ON_FAILURE)
