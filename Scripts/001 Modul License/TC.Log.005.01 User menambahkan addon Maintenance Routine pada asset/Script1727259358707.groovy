...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Button add asset'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Checkbox select tambah asset'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Button select asset'))
