...
WebUI.click(findTestObject('OBJ Modul License/Maintenance Tab/Button add asset'))

WebUI.click(findTestObject('OBJ Modul License/Maintenance Tab/Checkbox select tambah asset'))

WebUI.click(findTestObject('OBJ Modul License/Maintenance Tab/Button select asset'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.005.01 - User menambahkan addon Maintenance Routine pada asset.png', FailureHandling.STOP_ON_FAILURE)
