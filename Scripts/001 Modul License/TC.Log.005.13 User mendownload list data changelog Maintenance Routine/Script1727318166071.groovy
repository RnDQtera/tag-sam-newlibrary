...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Changelog/Button download'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.13 - User mendownload list data changelog Maintenance Routine.png', 
