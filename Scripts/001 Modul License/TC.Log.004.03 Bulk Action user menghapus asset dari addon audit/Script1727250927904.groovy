...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Bulk action tab audit'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/bulk Action remove from addon'))
