...
WebUI.click(findTestObject('OBJ Modul License/Asset Tab/Dropdown Field Model Type'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.03 - Melakukan filter Menampilkan Data Sesuai Field Model Type.png', FailureHandling.STOP_ON_FAILURE)
