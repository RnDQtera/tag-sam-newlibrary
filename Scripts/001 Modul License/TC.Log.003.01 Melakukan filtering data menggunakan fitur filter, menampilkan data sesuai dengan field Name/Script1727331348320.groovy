...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Field Name'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.01 - Melakukan filter Menampilkan Data Sesuai Field Name.png', FailureHandling.STOP_ON_FAILURE)
