...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Reapir Ticketing License'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.12 - Melakukan filter Menampilkan Data Sesuai Field Reapair Ticketing License.png', 
