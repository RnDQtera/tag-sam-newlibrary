...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Button Download Tab Asset'))

WebUI.delay(8)

WebUI.takeScreenshot('Screenshot/015. License/TC.003.14 - User mendownload list data asset.png', FailureHandling.STOP_ON_FAILURE)
