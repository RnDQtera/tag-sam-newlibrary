...
WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Button search changelog allocation'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Searchbox changelog allocation'), 'jawa')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Allocation/Changelog/Searchbox changelog allocation'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.002.05 - Changelog Melakukan filtering data menggunakan fitur search.png', 
