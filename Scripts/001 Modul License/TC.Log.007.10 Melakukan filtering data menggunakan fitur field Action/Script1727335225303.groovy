...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button select action changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Select action changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button apply changelog tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.10 - Melakukan filtering data menggunakan fitur field action.png', 
