...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button changelog tracking'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button filter changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button select date changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Select date changelog tracking'))

WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button apply changelog tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.09 - Melakukan filtering data menggunakan fitur field Date.png', FailureHandling.STOP_ON_FAILURE)
