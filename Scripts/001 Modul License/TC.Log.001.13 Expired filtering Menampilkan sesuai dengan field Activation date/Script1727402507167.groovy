...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Dropdown Activation Date Expired Tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Select activation date expired tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Expired/Button Aply Expired Tab'))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.13 - Expired filtering data menggunakan fitur filter, menampilkan data sesuai dengan field Activation date.png', 
