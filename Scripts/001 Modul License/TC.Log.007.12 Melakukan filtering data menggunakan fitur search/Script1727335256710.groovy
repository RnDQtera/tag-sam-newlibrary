...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Button search changelog tracking'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Searchbox changelog tracking'), 'remove')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Tracking/Changelog/Searchbox changelog tracking'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.12 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
