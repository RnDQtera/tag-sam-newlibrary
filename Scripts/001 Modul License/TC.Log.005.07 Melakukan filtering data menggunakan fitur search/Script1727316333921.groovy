...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button search'))

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Searchbox'), 'Urus')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Searchbox'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.07 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
