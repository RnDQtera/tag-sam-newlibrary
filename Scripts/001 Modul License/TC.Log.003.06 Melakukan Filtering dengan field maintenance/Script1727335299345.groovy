...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Field Mantenance'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.06 - Melakukan filter Menampilkan Data Sesuai Field Maintenance.png', FailureHandling.STOP_ON_FAILURE)
