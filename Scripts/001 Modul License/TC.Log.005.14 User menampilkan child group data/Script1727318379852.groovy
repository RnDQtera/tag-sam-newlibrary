...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Button show child group'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.005.14 - User menampilkan child group data.png', FailureHandling.STOP_ON_FAILURE)
