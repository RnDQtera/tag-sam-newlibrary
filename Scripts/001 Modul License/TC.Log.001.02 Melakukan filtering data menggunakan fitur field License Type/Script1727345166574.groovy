...
WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button select license existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Select license existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button apply existing tab'))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.02 - Melakukan filtering data menggunakan fitur filter, menampilkan data sesuai dengan field License type.png', 
