...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Dropdown Field TAG'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.04 - Melakukan filter Menampilkan Data Sesuai Field TAG.png', FailureHandling.STOP_ON_FAILURE)
