...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button select user'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Select user'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.11 - Melakukan filtering data menggunakan fitur field Modify By.png', 
