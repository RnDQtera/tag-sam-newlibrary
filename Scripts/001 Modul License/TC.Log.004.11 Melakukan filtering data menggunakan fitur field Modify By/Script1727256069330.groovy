...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Changelog/Button select user'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Changelog/Select user'))
