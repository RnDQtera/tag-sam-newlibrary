...
WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button edit tab allocation'))

WebUI.delay(5)

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab Allocation/Textbox input quota tab allocation'), '50')

WebUI.click(findTestObject('OBJ Modul License/Tab Allocation/Button save set quota tab allocation'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/015. License/TC.002.10 - Melakukan action edit set qouta fixed asset.png', FailureHandling.STOP_ON_FAILURE)
