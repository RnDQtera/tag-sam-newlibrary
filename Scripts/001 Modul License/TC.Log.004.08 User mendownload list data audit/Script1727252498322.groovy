...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/div_Modules_module-shadow w-110px h-110px f_1c4ea5'))
...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Button download list audit'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.08 - User mendownload list data audit.png', FailureHandling.STOP_ON_FAILURE)
