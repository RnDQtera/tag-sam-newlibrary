...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/div_Modules_module-shadow w-110px h-110px f_1c4ea5'))
...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Button download list audit'))
