...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Button bulk action'))

WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Bulk action remove from addon'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Submit remove from addon'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.006.03 - Bulk Action user menghapus asset dari addon repair ticketing.png', 
