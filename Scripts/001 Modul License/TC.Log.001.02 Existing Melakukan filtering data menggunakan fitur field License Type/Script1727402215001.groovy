...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Button select license existing tab'))

WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Select license existing tab'))
