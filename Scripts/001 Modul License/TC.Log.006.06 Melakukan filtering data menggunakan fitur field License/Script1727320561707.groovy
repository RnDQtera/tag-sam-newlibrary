...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button select license'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Select license'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.06 - Melakukan filtering data menggunakan fitur field license.png', 
