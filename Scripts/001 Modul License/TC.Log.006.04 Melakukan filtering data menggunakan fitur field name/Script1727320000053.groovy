...
WebUI.click(findTestObject('OBJ Modul License/Tab Repair Ticketing/Filter repair ticketing/Button Filter repair ticketing'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button select name'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Select name'))

WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.006.04 - Melakukan filtering data menggunakan fitur field Name.png', FailureHandling.STOP_ON_FAILURE)
