...
WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button filter existing tab'))

WebUI.delay(2)

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button select modul existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Select modul existing tab'))

WebUI.click(findTestObject('OBJ Modul License/All Licenses Tab/Button apply existing tab'))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.01 - Melakukan filtering data menggunakan fitur filter, menampilkan data sesuai dengan field Module.png', FailureHandling.STOP_ON_FAILURE)
