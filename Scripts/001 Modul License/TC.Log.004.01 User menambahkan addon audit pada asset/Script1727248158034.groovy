...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Tab Audit/Button add asset'))

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Tab Audit/select asset'))

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Tab Audit/button_Select'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Tab Audit/Button changelog tab audit'))
