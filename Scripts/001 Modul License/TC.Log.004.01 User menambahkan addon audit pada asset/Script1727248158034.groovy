...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/div_Modules_module-shadow w-110px h-110px f_1c4ea5'))
...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/Button add asset'))

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/select asset'))

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/button_Select'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/Button changelog tab audit'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.01 - User melakukan addon audit pada asset.png', FailureHandling.STOP_ON_FAILURE)
