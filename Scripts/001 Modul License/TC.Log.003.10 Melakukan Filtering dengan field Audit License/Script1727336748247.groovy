...
WebUI.click(findTestObject('OBJ Modul License/Asset Tab/Dropdown Field Audit License'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.003.10 - Melakukan filter Menampilkan Data Sesuai Field Audit License.png',
