...
WebUI.click(findTestObject('OBJ Modul License/Button Tab Expired'))

WebUI.click(findTestObject('OBJ Modul License/Button Download List Expired'))

WebUI.delay(5)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.16 - User mendownload list data All License Expired.png', FailureHandling.STOP_ON_FAILURE)
