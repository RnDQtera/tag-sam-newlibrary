...
WebUI.click(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Button search existing tab'))

WebUI.delay(2)

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Searchbox existing tab'), 'asset')

WebUI.sendKeys(findTestObject('OBJ Modul License/Tab All Licenses/Tab Existing/Searchbox existing tab'), Keys.chord(Keys.ENTER))

WebUI.delay(6)

WebUI.takeScreenshot('Screenshot/015. License/TC.001.07 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
