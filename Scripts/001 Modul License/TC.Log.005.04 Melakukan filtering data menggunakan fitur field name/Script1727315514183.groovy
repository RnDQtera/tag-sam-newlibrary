...
WebUI.click(findTestObject('OBJ Modul License/Tab Maintenance/Maintenance Filter/Button filter'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.005.04 - Melakukan filtering data menggunakan fitur field Name.png', FailureHandling.STOP_ON_FAILURE)
