...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Checkbox select asset tab audit'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/action remove asset tab audit'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/single action remove from addon'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Submit remove from addon'))
