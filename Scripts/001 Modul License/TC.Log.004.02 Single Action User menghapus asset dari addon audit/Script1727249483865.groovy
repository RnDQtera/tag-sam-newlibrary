...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Checkbox select asset tab audit'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/action remove asset tab audit'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/single action remove from addon'))
...
WebUI.takeScreenshot('Screenshot/015. License/TC.004.02 - Single Action User menghapus asset dari addon audit.png', FailureHandling.STOP_ON_FAILURE)
