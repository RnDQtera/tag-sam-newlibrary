...
WebUI.click(findTestObject('OBJ Modul License/Tab Tracking/Button show child group tracking'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.007.14 - User menampilkan child group data.png', FailureHandling.STOP_ON_FAILURE)
