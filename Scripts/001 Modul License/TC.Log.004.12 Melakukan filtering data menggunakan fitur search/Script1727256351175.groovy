...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Audit Tab/Changelog/Button changelog tab audit'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Button search'))

WebUI.sendKeys(findTestObject('Object Repository/OBJ Modul License/Audit Tab/Changelog/Searchbox'), 'remove')

WebUI.sendKeys(findTestObject('Object Repository/OBJ Modul License/Audit Tab/Changelog/Searchbox'), Keys.chord(Keys.ENTER))
