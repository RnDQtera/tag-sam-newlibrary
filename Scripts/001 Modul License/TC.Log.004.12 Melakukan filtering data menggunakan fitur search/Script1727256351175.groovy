...
WebUI.click(findTestObject('Object Repository/OBJ Modul License/Tab Audit/Changelog/Button changelog tab audit'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Changelog/Button search changelog audit'))

WebUI.sendKeys(findTestObject('Object Repository/OBJ Modul License/Tab Audit/Changelog/Searchbox changelog audit'), 'remove')

WebUI.sendKeys(findTestObject('Object Repository/OBJ Modul License/Tab Audit/Changelog/Searchbox changelog audit'), Keys.chord(Keys.ENTER))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.12 - Melakukan filtering data menggunakan fitur search.png', FailureHandling.STOP_ON_FAILURE)
