...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Select license'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Audit Filter/Checkbox select license'))
