...
WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Select license'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Checkbox select license'))

WebUI.click(findTestObject('OBJ Modul License/Tab Audit/Audit Filter/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.06 - Melakukan filtering data menggunakan fitur field license.png', 
