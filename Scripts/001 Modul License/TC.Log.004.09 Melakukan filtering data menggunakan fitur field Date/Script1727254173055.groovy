...
WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button changelog tab audit'))

WebUI.delay(3)

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button filter'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button Select date'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Select date'))

WebUI.click(findTestObject('OBJ Modul License/Audit Tab/Changelog/Button apply'))

WebUI.delay(7)

WebUI.takeScreenshot('Screenshot/015. License/TC.004.09 - Melakukan filtering data menggunakan fitur field Date.png', FailureHandling.STOP_ON_FAILURE)
