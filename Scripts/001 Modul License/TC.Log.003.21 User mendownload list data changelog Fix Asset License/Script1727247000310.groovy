...
WebUI.click(findTestObject('OBJ Modul License/Asset Tab/Changelog/Button Changelog Tab Asset'))

WebUI.click(findTestObject('OBJ Modul License/Asset Tab/Changelog/Button Download Changelog Asset'))

WebUI.delay(8)

WebUI.takeScreenshot('Screenshot/015. License/TC.003.21 - User mendownload list data changelog fix asset.png', FailureHandling.STOP_ON_FAILURE)
