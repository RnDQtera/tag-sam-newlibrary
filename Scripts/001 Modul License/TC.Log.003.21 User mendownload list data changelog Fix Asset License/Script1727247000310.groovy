...
WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Changelog/Button Changelog Tab Asset'))

WebUI.click(findTestObject('OBJ Modul License/Tab Asset/Changelog/Button Download Changelog Asset'))
