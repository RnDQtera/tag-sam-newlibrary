...
WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 48 - 49/Button download asset'))

WebUI.delay(2)

WebUI.takeScreenshot('Screenshot/014. Tag/TC.014.053 - Download history list asset.png', FailureHandling.STOP_ON_FAILURE)
