...
WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 48 - 49/Button Reported By Select User'))

WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 48 - 49/Checkbox user'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/OBJ Menu Tag/OBJ TC 48 - 49/button_Apply'))

WebUI.takeScreenshot('Screenshot/014. Tag/TC.014.049 - Melakukan filtering data dengan fitur field Reported By.png', FailureHandling.STOP_ON_FAILURE)
