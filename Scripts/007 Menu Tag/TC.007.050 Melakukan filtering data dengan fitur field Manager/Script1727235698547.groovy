...
WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 48 - 49/Button Select Manager'))

WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 48 - 49/Checkbox manager'))
...
WebUI.takeScreenshot('Screenshot/014. Tag/TC.014.050 - Melakukan filtering data dengan fitur field Manager.png', FailureHandling.STOP_ON_FAILURE)
