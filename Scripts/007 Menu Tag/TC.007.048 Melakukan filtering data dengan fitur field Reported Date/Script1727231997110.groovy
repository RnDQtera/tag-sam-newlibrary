...
WebUI.click(findTestObject('Object Repository/OBJ Menu Tag/OBJ TC 48 - 49/span_History'))

WebUI.click(findTestObject('OBJ Menu Tag/OBJ TC 43-44/i_History_mx-0 text-base icon ic-filter-lin_324d4a (1)'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/OBJ Menu Tag/OBJ TC 48 - 49/input_Reported date_w-full text-xs tracking_5ab07c'))

WebUI.click(findTestObject('Object Repository/OBJ Menu Tag/OBJ TC 48 - 49/span_19'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/OBJ Menu Tag/OBJ TC 48 - 49/button_Apply'))

WebUI.takeScreenshot('Screenshot/014. Tag/TC.014.048 - Melakukan filtering data dengan fitur field Reported Date.png', FailureHandling.STOP_ON_FAILURE)
