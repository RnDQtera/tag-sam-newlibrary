...
//
//WebUI.delay(8, FailureHandling.STOP_ON_FAILURE)
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.034 Sub Tab Audit'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.001 Add Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.002 Create Field Name'), 'Custom Field Audit')
...
WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.025 Text Field Search General Information'), 'Custom Field Audit')
...
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.027 Action Edit General Information'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.002 Create Field Name'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.setText(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.002 Create Field Name'), 'Edited Custom Field')

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.003 Choose Data Type'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.007 Select Data Type Date'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.017 Select Required No'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.023 Submit Create Custom Field'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.025 -Edit Custom Field Maintenance Routine.png', FailureHandling.STOP_ON_FAILURE)
