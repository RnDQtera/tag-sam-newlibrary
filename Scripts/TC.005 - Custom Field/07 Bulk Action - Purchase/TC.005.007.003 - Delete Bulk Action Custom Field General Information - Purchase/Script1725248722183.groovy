...
WebUI.click(findTestObject('OBJ.005 - Setting Custom Field/OBJ.005.042 Cancel Delete Custom FIeld'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.takeScreenshot('Screenshot/005.Custom Field/TC.005.031 - Delete bulk action.png', FailureHandling.STOP_ON_FAILURE)
